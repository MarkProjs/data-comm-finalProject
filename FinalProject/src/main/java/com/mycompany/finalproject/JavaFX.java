                ...
                btn.setOnAction((e) -> {
                        ...
                        try {
                                ...
                                if (this.currentUser.equals("MarkisAwesome")) {
                                        ...
                                        this.mqtt.getData("project/antonio", antDoorBellTxtA, antSensorTxtA,
                                                        antHumidTile, antTempTile, antImageTile);
                                        this.mqtt.connectClient();
                                        this.mqtt.subscribe("project/jeremy");
                                        this.mqtt.subscribe("project/antonio");
                                } else if (this.currentUser.equals("asimonelli")) {
                                        this.mqtt.getData("project/jeremy", jerDoorBellTxtA, jerSensorTxtA,
                                                        jerHumidTile, jerTempTile, jerImageTile);
                                        this.mqtt.getData("project/mark", markDoorBellTxtA, markSensorTxtA,
                                                        markHumidTile, markTempTile, markImageTile);
                                        this.mqtt.connectClient();
                                        this.mqtt.subscribe("project/jeremy");
                                        this.mqtt.subscribe("project/mark");
                                } else if (this.currentUser.equals("jeremy")) {
                                        this.mqtt.getData("project/antonio", antDoorBellTxtA, antSensorTxtA,
                                                        antHumidTile, antTempTile, antImageTile);
                                        this.mqtt.getData("project/mark", markDoorBellTxtA, markSensorTxtA,
                                                        markHumidTile, markTempTile, markImageTile);
                ...
                btn.setOnAction((e) -> {
                        try {
                                ...
                                if (this.currentUser.equals("MarkisAwesome")) {
                                        ...
                                        this.threads.setTopic("project/antonio");
                                        this.threads.startPublishThread(antDoorBellTxtA, antSensorTxtA, antHumidTile,
                                                        antTempTile, antImageTile);
                                        this.threads.startDoorBellThread(antDoorBellTxtA);
                                        this.threads.startDHTThread(antHumidTile, antTempTile);
                                        this.threads.startSenseLEDThread(antSensorTxtA, antImageTile);
                                } else if (this.currentUser.equals("jeremy")) {
                                        this.threads.setTopic("project/jeremy");
                                        this.threads.startPublishThread(jerDoorBellTxtA, jerSensorTxtA, jerHumidTile,
                                                        jerTempTile, jerImageTile);
                                        this.threads.startDoorBellThread(jerDoorBellTxtA);
                                        this.threads.startDHTThread(jerHumidTile, jerTempTile);
                                        this.threads.startSenseLEDThread(jerSensorTxtA, jerImageTile);
                                }
                        } catch (Exception exc) {
                                Logger.getLogger(JavaFX.class.getName()).log(Level.SEVERE, null, exc);
                                System.out.println(exc);
        ...
        private VBox buildTiles() throws IOException {
                ...
                antImageTile = TileBuilder.create()
                                ...
                                .image(new Image(Objects.requireNonNull(
                                                getClass().getResourceAsStream("/defaultImage/sunny-clip-art.png"))))
                                .imageMask(Tile.ImageMask.RECTANGULAR)
                                .build();
